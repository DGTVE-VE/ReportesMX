...
//////////////////////////////////////////////////////
			...
			if($inscrito_curso[$k]==NULL || $inscrito_curso[$k][0]->course_name == ""){
						$eficiencia = array ($lista_constancias[$k]->nombre_curso, $key->constancia, $inscrito_curso[$r][0]->inscritos, 'Porcentaje');
			}
