    ...
    <form action="{{url('nuevoRegistro')}}" method="POST" id="body" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <input name="nombreCurso" type="text" class="form-control" id="curseName" placeholder="Aquí va e nombre del curso"required>
            </div>        
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">              
                ...
                <div class="col-md-12">
                    <div class="col-md-3">
                        <label for="courseResults">Fecha de lanzamiento</label>    
                    ...
                    <div class="col-md-3">
                        <label for="courseResults">Fecha de inicio</label>    
                    ...
                    <div class="col-md-3">
                        <label for="courseResults">Fecha de fin de curso</label>
                    ...
                    <div class="col-md-3">
                        <label for="courseResults">Fecha emisión de constancias</label>    
        ...
        <div class="row">
            <div class="col-md-12">                
                ...
                <div class="col-md-5">
                    ...
                    <input name="duracionCurso"type="number" name="quantity" min="1" max="15"><br>
                    <div class="help-tip">
                ...
                <div class="col-md-5">
                    ...
                    <input name="esfuerzoReq"type="number" name="quantity" min="1" max="20"><br>
                    <div class="help-tip">
