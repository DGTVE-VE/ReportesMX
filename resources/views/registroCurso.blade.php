...
<html>
    <head>
        <title>Reportes MéxicoX </title>

        <!-- Bootstrap CSS -->
        <link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css">
        <link rel="stylesheet" href="{{ asset('css/fichaCss.css') }}" >   
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane fade" id="contactos"> <!--bloque contactos-->
                                    <form  action="{{url('nuevoRegistro')}}" method="POST" id="body" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <label for="telefonoInstitucion">Número telefónico y extensión</label>
                                            <input name="telefonoInst" type="text" class="form-control" placeholder="Escribe el número telefónico" required>
                                            <div class="help-tip posicion">
                                                <p>- Número telefónico de la institución 
                                                    <br/>- Incluir clave lada y extensión
                                                </p>
                                            </div><br>
                                        </div>
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <label for="cargoInstitucion">Nombre del puesto</label>
                                            <input name="cargoInst" type="text" class="form-control" placeholder="Escribe el cargo" required>
                                            <div class="help-tip posicion">
                                                <p>-Cargo/puesto dentro de la institución 
                                                </p>
                                            </div><br>
                                        </div>                                        
                                        <div class="form-group col-md-8 col-md-offset-2">
                                        ...
                                        <div class="form-group col-md-12" id="botonesFin"><br>
                                            <button id="quitaInst1" type="submit" class="col-md-4 col-md-offset-1  quitaInst btn btn-danger">Quitar Contacto</button>    
                                            
                                            <button id="otroIns" class=" col-md-4 col-md-offset-2 btn btn-primary">Agregar Contacto</button>  
                                        </div>                                        
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <div class="col-md-12 col-md-offset-5">
                                                <button type="submit" class="btn btn-success">Guardar</button>
                                ...
                                <div class="tab-pane fade" id="staff"> <!--bloque staff-->
                                    <form  action="{{url('nuevoRegistro')}}" method="POST" id="body" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <label for="Academic">Formación académica</label>
                                            <input name="biografia[]" class="form-control" id="instructorBiography" placeholder="Escribe el nombre de la formación académica alcanzada (Ingeniero en ......) ">   
                                            <div class="help-tip posicion">
                                                <p>- Especificar el título académico alcanzado</p>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <label for="specialization">Áreas de investigación</label>
                                            <textarea name="especializacion[]" class="form-control" placeholder="Describir las áreas de investigación en donde ha participado"></textarea>   
                                            <div class="help-tip posicion">
                                                <p>- Principales áreas de investigación</p>
                                            </div>
                                        </div>     
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <label for="addInformation">Información adicional</label>
                                            <textarea name="informacionAdd[]" class="form-control" placeholder="Escribe información adicional relacionada al trabajo desarrollado en su área profesional"></textarea>    
                                            <div class="help-tip posicion">
                                                <p>- Obras destacadas en las que ha colaborado
                                                    <br/>- Publicaciones científicas
                                                    <br/>- Sitios Web de investigación</p>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-5 col-md-offset-3"><br>
                                            <label for="addInstructor">Agregar fotografía del instructor</label><br><br>
                                            <label class="file">
                                        ...
                                        <div class="form-group col-md-8 col-md-offset-3" id="botonesFin"><br>
                                ...
                                <div class="tab-pane fade" id="constancias"> <!--bloque constancias-->
                                    <form  action="{{url('nuevoRegistro')}}" method="POST" id="body" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <label for="tituloAcademico">Título profesional</label>
                                            <input name="titleAcademic[]" class="form-control" id="instructorBiography" placeholder="Escribe el título profesional (Ingeniero en ......)">   
                                            <div class="help-tip posicion">
                                                <p>- Especificar el título académico alcanzado</p>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <label for="cargoInstitucion">Cargo en la Institución</label>
                                            <input name="positionInst[]" class="form-control" id="instructorBiography" placeholder="Escribe el casrgo que desempeña dentro de la Institución (Director, subdirector....)">   
                                            <div class="help-tip posicion">
                                                <p>- Especificar el cargo que desempeña en la institución</p>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-8 col-md-offset-3" id="botonesFin"><br>
                                            <button id="quitaAsesor" type="submit" class="quitaInst btn btn-danger">Quitar Asesor</button>    
                                            <button id="otroAsesor" class="btn btn-primary">Agregar otro Asesor</button>  
                                        </div>
                                        <div class="form-group col-md-8 col-md-offset-2">
                                            <hr>
                                        </div>
